...
export const publicErrorCodeSchema = z.enum([
  ...
  "historic_alias_duplicate",
  "historic_alias_self",
  "historic_alias_not_found",
  "tier_not_found",
  "discovery_not_ready",
  "rate_limited",
...
export const publicErrorHttpStatus = {
  ...
  historic_alias_duplicate: 409,
  historic_alias_self: 400,
  historic_alias_not_found: 404,
  tier_not_found: 404,
...
export const publicErrorMessages = {
  ...
  historic_alias_duplicate: "This historic alias is already linked.",
  historic_alias_self: "A character cannot be its own historic alias.",
  historic_alias_not_found: "This historic alias is no longer linked.",
  tier_not_found: "The raid tier was not found.",
